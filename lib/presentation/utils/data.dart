...
List pageViewData = [
  ...
  },
  {
    "title": "How to Use",
    "body":
        "A simple illustration or diagram demonstrating the process of capturing a photo of a plant, analyzing it, and learning from the results. You could use icons representing a camera, analysis, and a book or knowledge symbol.",
  },
];

List<String> option1 = [
  "📷 Tap 'Select Image' button.",
  "🖼️ Choose an image from your gallery.",
  "✅ Confirm selection.",
  "🚀 Tap 'Upload' to upload the image.",
];

List<String> option2 = [
  "📸 Tap 'Take a Picture' button.",
